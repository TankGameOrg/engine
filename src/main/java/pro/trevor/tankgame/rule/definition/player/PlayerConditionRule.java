...
public class PlayerConditionRule implements IPlayerRule {
     ...
     * @return A result indicating if an the rule can be applied or the reason(s) why it can't be
     */
    public Result<List<String>> canApplyConditional(State state, PlayerRef subject) {
        return condition.test(state, subject);
    }
     ...
     * @param state The state to test
     * @param subject The player who will be appling the rule
     * @param meta The meta data from the log entry
     * @return A result indicating if an the rule can be applied or the reason(s) why it can't be
     */
