...
public class PlayerRule implements IPlayerRule {
    ...
    public PlayerRule(String name, String description, RuleCondition condition, Consumer<PlayerRuleContext> consumer, Function<PlayerRuleContext, List<LogFieldSpec<?>>> logFieldSource) {
        this(name, description, condition, consumer, logFieldSource, List.of());
    }

    public PlayerRule(String name, String description, RuleCondition condition, Consumer<PlayerRuleContext> consumer, Function<PlayerRuleContext, List<LogFieldSpec<?>>> logFieldSource, List<String> stages) {
        this.name = name;
