...
public class ConditionalRules {
    public static final ConditionalRule<BasicWall> DESTROY_WALL_ON_ZERO_DURABILITY =
            new ConditionalRule<>(
    ...
    public static final ConditionalRule<Tank> KILL_OR_DESTROY_TANK_ON_ZERO_DURABILITY =
            new ConditionalRule<>(
    ...
    public static final ConditionalRule<Board> TANK_WIN_CONDITION =
            new ConditionalRule<>(
                    (s, b) ->
                            b.gatherUnits(Tank.class).stream()
                                            .filter((t) -> !t.isDead())
    ...
    public static final ConditionalRule<ArmisticeCouncil> ARMISTICE_COUNCIL_WIN_CONDITION =
            new ConditionalRule<>(
